...
# Automatically find all .json files in the experiments directory
experiments_dir = '/Users/samimarreed/dev/cuga-agent/experiments'
files = [f for f in os.listdir(experiments_dir) if f.endswith('.json')]
...
with open('/Users/samimarreed/dev/cuga-agent/experiments/comparison.html', 'w') as f:
    f.write(html)

print('Updated comparison.html to load JSONs via fetch')
